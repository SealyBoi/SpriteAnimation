...
function preload() {
  spriteSheet = loadImage("images/SpelunkyGuy.png");
  spriteSheet2 = loadImage("images/Green.png");
  spriteSheet3 = loadImage("images/Viking.png");
}
...
function setup() {
  ...
  walkingAnimation = new WalkingAnimation(spriteSheet,80,80,300,100,9);
  walkingAnimation2 = new WalkingAnimation(spriteSheet2,80,80,100,200,9);
